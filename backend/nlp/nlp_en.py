# import nltk
# from nltk.corpus import floresta, brown
...
def syntactic_analysis(text):
	...
	for i in range(len(text_list)):
		sent_list = nltk.sent_tokenize(text_list[i])
		sent_text = sent_text + sent_list
				
	tagged = []
	for sentence in sent_text:
		words_tokenize = nltk.tokenize.word_tokenize(sentence)
		sent_tag = nltk.pos_tag(words_tokenize, tagset='universal')
...
#text = 'Sentença 1\n\nAqui vem o corpo do texto. Aqui começa uma nova sentença. Aqui outra sentença.\nEssa é uma nova sentença. Aqui temos outra.'
#text = 'The complex number system can be defined as the algebraic extension of the ordinary real numbers by an imaginary number i.'
